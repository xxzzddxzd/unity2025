...
-(long)getTimeScaleAddr{
    long timeScaleAddr = ((long (*)(const char *))u3dsystemfunc)("UnityEngine.Time::set_timeScale");
...
- (long)resolveFromSymbol {
    ...
    // 优先使用 MSFindSymbol，如果失败则用 dlsym 作为后备（兼容 Dopamine/ElleKit）
    void *il2cpp_resolve_icall_0 = MSFindSymbol(0, "_il2cpp_resolve_icall");
    if (!il2cpp_resolve_icall_0) {
        il2cpp_resolve_icall_0 = dlsym(RTLD_DEFAULT, "il2cpp_resolve_icall");
        XLog(@"dlsym fallback for il2cpp_resolve_icall: %p", il2cpp_resolve_icall_0);
    }
    if (il2cpp_resolve_icall_0) {
        // il2cpp_resolve_icall 位置需要跳转的位置
        XLog(@"*(int*)il2cpp_resolve_icall_0 %lx %lx ", (unsigned long)il2cpp_resolve_icall_0, *(long*)il2cpp_resolve_icall_0 & 0xff000000);
